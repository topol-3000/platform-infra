...
```bash
INIT=$(node "/home/yevhenii/projects/saas/platform-infra/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/yevhenii/projects/saas/platform-infra/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
