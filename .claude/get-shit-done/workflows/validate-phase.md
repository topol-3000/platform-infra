...
```
Agent(
  prompt="Read /home/yevhenii/projects/saas/platform-infra/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/yevhenii/projects/saas/platform-infra/.claude/get-shit-done/templates/VALIDATION.md`
