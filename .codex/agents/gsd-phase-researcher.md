...
@/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
