...
```bash
INIT=$(node "/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
