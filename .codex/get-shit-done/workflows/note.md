...
- **Global scope**: `/home/yevhenii/projects/saas/platform-infra/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/yevhenii/projects/saas/platform-infra/.codex/notes/`)
...
2. Glob `/home/yevhenii/projects/saas/platform-infra/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/yevhenii/projects/saas/platform-infra/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/yevhenii/projects/saas/platform-infra/.codex/notes/` — works in any directory
