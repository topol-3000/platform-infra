...
```
Agent(
  prompt="Read /home/yevhenii/projects/saas/platform-infra/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/templates/SECURITY.md`
