...
```bash
INIT=$(node "/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/yevhenii/projects/saas/platform-infra/.codex/get-shit-done/templates/spec.md.
